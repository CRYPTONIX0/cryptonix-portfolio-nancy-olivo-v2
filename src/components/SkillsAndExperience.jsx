...
import { experiences, skills } from "../constants/index"; // Asegúrate de que la ruta sea correcta
import { layout } from "../style";
import { motion } from "framer-motion";
import { BsLink45Deg } from "react-icons/bs"; // Asegúrate de importar correctamente

// Componente para el ícono de habilidad
export const SkillIcon = ({ icon, name }) => {
  return (
    <div className="flex flex-col">
      <span className="text-white text-[30px] hover:text-teal-200">
        {icon}  {/* Aquí se renderiza el icono manualmente */}
      </span>
...
// Componente para el contenido de cada experiencia
  ...
  return (
    ...
    >
      <div className="flex flex-row items-center mb-6">
        ...
        />
        <h4 className="font-poppins font-semibold text-[20px] text-white leading-[32px] ml-2">
          {props.organisation}
        </h4>
      </div>
