...
import { extraCurricular } from "../constants/index"; // Importando las actividades extracurriculares
import { BsLink45Deg } from "react-icons/bs";
import { motion } from "framer-motion";

// Componente para mostrar el contenido de cada actividad
...
// Componente para mostrar una tarjeta de actividad extracurricular
  ...
  return (
    ...
    >
      <div className="flex flex-row">
        {/* Usamos el emoji como logo */}
        <span className="w-[52px] h-[52px] text-3xl">{props.logo}</span>
  ...
  return (
    <section id="extraCurricular">
      ...
      <div className={`${styles.flexCenter} flex-col relative mb-4 mt-8`}>
        ...
        {/* Aquí renderizamos las tarjetas de actividades extracurriculares */}
